$(document).ready(function () {
    ...
    var grid = $("#report-grid-notgh").kendoGrid({
        //toolbar: ["excel"],
        //excel: {
        ...
        toolbar: fromReportPage ? [
        ...
        ] : [
            {
                template:
                    `<div class="row">
                        <div style="margin-right: 20px;margin-top:6px;">#if('${url_create}' != ''){#<a class="k-button" href="${url_create}" >ایجاد نطق</a>#}#</div>
                        <div class="col-md-3 ">
                                <div class="input-group">
                                    <input style="height: 40px;margin-top:0px;" type="text" class="form-control" id='FieldFilter' placeholder="جستجو...">
                                </div>
        ...
        columns: [
            ...
            { field: "myData.jalaseAlaniPersianDate", title: "تاریخ جلسه علنی", media: "(min-width: 300px)", width: 123, filterable: true },
            ...
            { field: "myData.pasokhStateDesc.name", title: "وضعیت پاسخ", media: "(min-width: 300px)", width: 100 },
            { field: "myData.pasokhNo", title: "شماره پاسخ", media: "(min-width: 300px)", width: 100 },
            { field: "myData.pasokhPersianDate", title: "تاریخ پاسخ", media: "(min-width: 300px)", width: 100 },
           ...
           
            {
                ...
                , template: fromReportPage ?
                    `<button class="k-button" data-link="${url_details_notgh}/?notghId=#:id#">جزییات</button>`
                    : btns
            }
        ]
    }).data("kendoGrid");
    ...
    function onDataBound(e) {
        var grid = $("#report-grid-notgh").data("kendoGrid");
    ...
    $("#FieldFilter").keyup(function () {
        ...
        grid = $("#report-grid-notgh").data("kendoGrid");
        if (value) {
