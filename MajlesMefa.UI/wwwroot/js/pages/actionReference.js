$(document).ready(function () {
    ...
    var grid = $("#report-grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "actionerName", title: "نام فرستنده", media: "(min-width: 200px)", width: 100 },
            { field: "description", title: "توضیحات", media: "(min-width: 200px)", width: 150 },
            { field: "refTypeDesc", title: "نوع ارجاع", media: "(min-width: 200px)", width: 100 },
            { field: "refUserName", title: "نام گیرنده", media: "(min-width: 200px)", width: 200 },
            { field: "created", title: "تاریخ ارسال", media: "(min-width: 200px)", width: 200 },
