$(document).ready(function () {
    ...
    var grid = $("#report-grid-tahghigh").kendoGrid({
        //toolbar: ["excel"],
        //excel: {
        ...
        toolbar: fromReportPage ? [
        ...
        ] : [
            {
                template:
                   `<div class="row">
                        <div style="margin-right: 20px;margin-top:6px;">#if('${url_create}' != ''){#<a class="k-button" href="${url_create}" >ایجاد تحقیق و تفحص</a>#}#</div>
                        <div class="col-md-3 ">
                                <div class="input-group">
                                    <input style="height: 40px;margin-top:0px;" type="text" class="form-control" id='FieldFilter' placeholder="جستجو...">
                                </div>
        ...
        excel: {
            fileName: "tahghigh-tafahos.xlsx",
            filterable: true,
            allPages: true,
        },
        ...
        columns: [
            ...
            { field: "title", title: "موضوع تحقیق و تفحص", media: "(min-width: 250px)", width: "160px" },
            ...
            { field: "myData.tahghighTafahosVazyatDesc.name", title: "وضعیت", media: "(min-width: 300px)" },
            { field: "categoryName", title: "موضوع", media: "(min-width: 300px)" },
            { field: "commissionTitle", title: "کمیسیون مربوطه", media: "(min-width: 300px)" },
            {
                title: "عملیات",
                ...
                , template: fromReportPage ?
                    `<button class="k-button" data-link="${url_details_tahghigh}/?tahghighTafahosId=#:id#">جزییات</button>`
                    : btns
            }
        ]
    }).data("kendoGrid");
    ...
    $("#FieldFilter").keyup(function () {
        ...
        grid = $("#report-grid-tahghigh").data("kendoGrid");
        if (value) {
