$(document).ready(function () {
    ...
    var grid = $("#report-grid-soal").kendoGrid({
        //toolbar: ["excel"],
        //excel: {
        ...
        toolbar: fromReportPage ? [
        ...
        ] : [
            {
                template:
                    `<div class="row">
                        <div style="margin-right: 20px;margin-top:6px;">#if('${url_create}' != ''){#<a class="k-button" href="${url_create}" >ایجاد سوال</a>#}#</div>
                        <div class="col-md-3 ">
                                <div class="input-group">
                                    <input style="height: 40px;margin-top:0px;" type="text" class="form-control" id='FieldFilter' placeholder="جستجو...">
                                </div>
        ...
        columns: [
            ...
            { field: "senatorHozeEntekhabi", title: "حوزه انتخابی نماینده", media: "(min-width: 300px)", width: "130px" },
            { field: "title", title: "عنوان", media: "(min-width: 200px)", width: "105px" },
            { field: "categoryParentName", title: "معاونت مربوطه", media: "(min-width: 200px)", width: "115px" },
            { field: "myData.karbargDateStr", title: "تاریخ کاربرگ", media: "(min-width: 200px)", width: "105px" },
            { field: "myData.questionStatusDesc.name", title: "وضعیت سوال", media: "(min-width: 200px)", filterable: false, width: "250px" },
            ...
            //{ field: "myData.accessActionRefrence.accessAction", hidden: true },
            {
                ...
                , template: fromReportPage ?
                    `<button class="k-button" data-link="${url_details_soal}/?soalId=#:id#">جزییات</button>`
                    : btns
            }
        ]
    }).data("kendoGrid");
    ...
    $("#FieldFilter").keyup(function () {
        ...
        grid = $("#report-grid-soal").data("kendoGrid");
        if (value) {
