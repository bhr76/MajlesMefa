$(document).ready(function () {
    ...
    var grid = $("#report-grid").kendoGrid({
        ...
        toolbar: [
            {
                template:
                    `<div class="row">
                       ...
                       <div style="margin-right: 20px;margin-top:10px;"><a class="k-button" href="${url_create}" >ایجاد کاربر</a></div>
                            <div class="col-md-3 ">
        ...
        columns: [
            ...
            { field: "name", title: "نام", media: "(min-width: 200px)" },
            { field: "roleDesc.name", title: "نقش", media: "(min-width: 200px)", filterable: false },
