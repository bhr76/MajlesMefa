$(document).ready(function () {
    ...
    var grid = $("#report-grid-ezharat").kendoGrid({
        //toolbar: ["excel"],
        //excel: {
        ...
        toolbar: fromReportPage ? [
        ...
        ] : [
            {
                template:
                    `
                    <div class="row">
                        <div style="margin-right: 20px;margin-top:6px;">#if('${url_create}' != ''){#<a class="k-button" href="${url_create}" >ایجاد اظهارات</a>#}#</div>
                        <div class="col-md-3 ">
                                <div class="input-group">
                                    <input style="height: 40px;margin-top:0px;" type="text" class="form-control" id='FieldFilter' placeholder="جستجو...">
                                </div>
...
`
        ...
        columns: [
            ...
            { field: "senatorHozeEntekhabi", title: "حوزه انتخابی نماینده", media: "(min-width: 200px)"},
            {
                title: "عملیات",
                ...
                , template: fromReportPage ?
                    `<button class="k-button" data-link="${url_details_ezharat}/?ezharatId=#:id#">جزییات</button>`
                    : btns
    ...
    $("#FieldFilter").keyup(function () {
        ...
        grid = $("#report-grid-ezharat").data("kendoGrid");
        if (value) {
